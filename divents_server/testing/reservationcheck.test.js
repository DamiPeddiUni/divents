...
describe("Reservation check testing", () => {
    ...
    test("A POST request at /api/v2/checkReservation with a valid code but an invalid authtoken must return an authorization error", async () => {
        return request(app)
    ...
    test("A POST request at /api/v2/checkReservation with a valid code must return if the reservation is accepted or not", async () => {
        return request(app)
        .post('/api/v2/checkReservation/1')
        .set('authtoken', token)
        .send({qrCode: "1234"})
    ...
    test("A POST request at /api/v2/checkReservation with a not valid code must return if the reservation is accepted or not", async () => {
        return request(app)
        .post('/api/v2/checkReservation/1')
        .set('authtoken', token)
        .send({qrCode: "12345"})
